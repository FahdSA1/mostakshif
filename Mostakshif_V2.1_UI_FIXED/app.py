...
def render_home_map_section():
    """
    كل القائمة + الخريطة + بطاقة التفاصيل بهذا القسم.
    (تراجعنا مؤقتًا عن استخدام @st.fragment هنا لأنها تحتاج نسخة أحدث من
    Streamlit، وقد تكون سبب الثقل الأخير إذا كانت النسخة المنشورة أقدم.)
    """
